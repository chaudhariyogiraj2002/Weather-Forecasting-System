...
# To test/print the json data received after putting a valid API key
# import requests
# # generate new API in case this expires
# def result():
#       r = requests.get(f"http://api.openweathermap.org/data/2.5/forecast?q=mumbai&appid=1a143f09be2b533e0c454a20fe4dc63e").json()
#       print(r)
